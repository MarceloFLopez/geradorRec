const dadosPacientes = [
    ...
    {
      nomePaciente: "Nathan Chaves da Silva",
      idade: 31,
    ...
    {
      nomePaciente: "Benjamin da Cunha Santos",
      idade: 38,
